...
# Tutorial 02 - Save selected results
This example shows how to select results for saving. Saving only selected results can save time.    
...
```{r, echo=FALSE}
results_GlacierDischarge_savePath <- "C:/Users/bea/Documents/test_rsminerve/RSM_Scripts/Example VBS/Outputs/tutorial02-results_GlacierDischarge.dsx"
results_SWE_savePath <- "C:/Users/bea/Documents/test_rsminerve/RSM_Scripts/Example VBS/Outputs/tutorial02-results_SWE.dsx"
presimreport_path <- "C:/Users/bea/Documents/test_rsminerve/RSM_Scripts/Example VBS/Outputs/tutorial02-preSimulationReport.txt"
postsimreport_path <- "C:/Users/bea/Documents/test_rsminerve/RSM_Scripts/Example VBS/Outputs/tutorial02-postSimulationReport.txt"
```

```{r result-paths, eval=FALSE}
results_GlacierDischarge_savePath <- 
  "C:/Users/<username>/Documents/scriping_rsm/tutorial02-results_GlacierDischarge.dsx"
results_SWE_savePath <- 
  "C:/Users/<username>/Documents/scriping_rsm/tutorial02-results_SWE.dsx"
presimreport_path <- 
  "C:/Users/<username>/Documents/scriping_rsm/tutorial02-preSimuReport.txt"
postsimreport_path <- 
  "C:/Users/<username>/Documents/scriping_rsm/tutorial02-postSimuReport.txt"
```
...
result_glacier <- readResultDXT(results_GlacierDischarge_savePath, chunk_size)
result_swe <- readResultDXT(results_SWE_savePath, chunk_size)
