...
```{r, echo=FALSE}
results_savePath <- "C:/Users/bea/Documents/test_rsminerve/RSM_Scripts/Example VBS/Outputs/tutorial05-results.dsx"
presimreport_path <- "C:/Users/bea/Documents/test_rsminerve/RSM_Scripts/Example VBS/Outputs/tutorial05-preSimulationReport.txt"
postsimreport_path <- "C:/Users/bea/Documents/test_rsminerve/RSM_Scripts/Example VBS/Outputs/tutorial05-postSimulationReport.txt"
```
...
if (EndDatePrevious >= StartDateNew & EndDatePrevious < EndDateNew) {
  clrCall(rsm, "SetStartDate", format(EndDatePrevious, format = "%m.%d.%Y %H:%M:%S")) 
} else {
