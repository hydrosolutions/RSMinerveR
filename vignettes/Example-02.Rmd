...
if (dir.exists(output_path)) {
  ...
  results_GlacierDischarge_savePath <- file.path(output_path, 
                                                 "tutorial02-results_GlacierDischarge.dsx")
  results_SWE_savePath <- file.path(output_path, "tutorial02-results_SWE.dsx")
  presimreport_path <- file.path(output_path, "tutorial02-preSimulationReport.txt")
  postsimreport_path <- file.path(output_path, "tutorial02-postSimulationReport.txt")
