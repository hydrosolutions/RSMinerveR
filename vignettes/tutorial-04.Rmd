...
parameter_file <- if (file.exists("../inst/extdata/Tutorial_Parameters_1.txt")) {
...
```{r, echo=FALSE}
results_SWE_savePath <- "C:/Users/bea/Documents/test_rsminerve/RSM_Scripts/Example VBS/Outputs/tutorial03-results_SWE_"
...
result_swe <- NULL
for (i in c(1:5)) {
  temp <- readResultDXT(results_SWE_savePath, chunk_size)
  temp <- temp %>%
    dplyr::mutate(`Parameter set` = i)
